...
class LocalData @Inject constructor(val context: Context) {
    ...
    fun doLogin(loginRequest: LoginRequest): Resource<LoginResponse> {
        if (loginRequest == LoginRequest("gouravgupta840@gmail.com", "gourav")) {
            return Resource.Success(LoginResponse("123", "Gourav", "Gupta",
                    "Lal Building", "40", "832108", "Jharkhand",
                    "India", "gouravgupta840@gmail.com"))
        }
